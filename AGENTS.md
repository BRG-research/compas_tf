...
- [docs/index.md](docs/index.md): mkdocs-material entry point (`mkdocs.yml` holds the nav)
- [docs/installation.md](docs/installation.md): Install instructions
- [docs/examples/](docs/examples/): One page per reading example, each including the script itself
- [docs/api/](docs/api/): API reference, generated by mkdocstrings
