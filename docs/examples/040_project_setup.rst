...
complete version is `compas_tf_example
<https://github.com/BRG-research/compas_tf_example>`_.
...
With `uv <https://docs.astral.sh/uv/getting-started/installation/>`_:
...
With pip instead: ``python -m venv .venv``, activate it, ``pip install
compas_tf``.
