...
class SurfaceElement(Element):
    """Class representing a surface element.

    Parameters
    ----------
    mesh : :class:`compas.datastructures.Mesh`
        The mesh geometry of the surface.
    transformation : :class:`compas.geometry.Transformation`, optional
        The transformation of the surface.
    features : list[:class:`SurfaceFeature`], optional
    ...
    def __init__(
        ...
        features: Optional[list[SurfaceFeature]] = None,
